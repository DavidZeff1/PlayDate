  ...
  state.notifications.push(
    {
      ...
      title: 'The Shapiro Family would like to connect',
      body: 'They mentioned LEGO — you can accept, decline, or decide later.',
      createdAt: at(5),
      read: false,
      href: '/app/requests',
    },
    {
      ...
      familyId: COHEN,
      kind: 'new_message',
      title: 'New message from the Levi Family',
      body: 'Would a playground meet-up on Saturday afternoon suit you?',
      createdAt: at(18),
      read: false,
      href: '/app/messages',
    },
    {
      ...
      title: 'Playdate confirmed with the Levi Family',
      body: 'Saturday 15:00 at Gan Sacher — main playground.',
      createdAt: at(40),
      read: true,
      href: '/app/playdates',
    },
    {
      ...
      familyId: COHEN,
      kind: 'connection_request',
      title: 'The Katz Family would like to connect',
      body: 'Both children are 8 and share three interests.',
      createdAt: at(20),
      read: false,
      href: '/app/requests',
    },
